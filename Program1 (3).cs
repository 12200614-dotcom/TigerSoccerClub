...
namespace TigerSoccerClub
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string s = "*****Welcome to Tiger Soccer Club Registration System*****";
            ...
            else
            {
                if(Players == 1)
                {
                    ...
                    static double CalculatePrice(string registration, string jersey)
                    {
                        int kids = 150;
                        int adult = 230;
                        int jerseyPrice = 100;

                        double total = registration == "Kids" ? kids : adult;
